...
#define PAG_LOG_INIT_CODE (L_USER_START>>12) // 0x100 
#define FRAME_INIT_CODE (PH_USER_START>>12) // 0x100
#define NUM_PAG_CODE 8
#define PAG_LOG_INIT_DATA (PAG_LOG_INIT_CODE+NUM_PAG_CODE) // 0x108
...
#define USER_FIRST_PAGE	(L_USER_START>>12) // 0x100
